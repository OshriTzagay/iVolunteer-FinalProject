...
function Welcome () {
    return(<div className="lioe">
        <div className="welcome">
        <h1 > Welcome To iVolunteer </h1>
        <h1 > How we are: </h1>
        <p> iVolunteer is ........... </p>
        <h1 > Lior : </h1>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequatur voluptatum repellat modi nihil voluptas voluptate quam, suscipit, quia aliquid laudantium reiciendis! Totam laboriosam repellendus rerum ratione distinctio porro aspernatur rem.
